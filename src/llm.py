...
# def parse_llm_response_for_angle(llm_text, user_input_raw, current_angle, min_angle, max_angle, default_step):
...
#     target_open_full = max_angle
#     target_close_full = min_angle
#     if "open" in user_input_lower:
#         if "bit" in user_input_lower or "slightly" in user_input_lower:
#             new_angle = min(max_angle, current_angle + default_step)
...
#         if "bit" in user_input_lower or "slightly" in user_input_lower:
#             new_angle = max(min_angle, current_angle - default_step)
#         elif "fully" in user_input_lower or "all the way" in user_input_lower:
